...
WebUI.click(findTestObject('Object Repository/Page_Explore/a_plusCreate a community'))
...
WebUI.click(findTestObject('Object Repository/Page_New community/p_Public'))
